			...
			<Router>
				<div className="app">
						...
						<div className="container">
							<div className="col-md-9 m-auto pt-5 pb-5">
								...
								<Route
									...
									exact={true}
									render={({ match, location, history }) => (
                                        <Content props={{articleListData, articleRequest, match, location, history, single: true }} />
									)}
								></Route>
								{/* <Route
									path="/articles"
                    ...
                    <Content props={{articleListData, articleRequest, match, location, history }} />
                                ...
                                ></Route>
								<Route path="/new-article" exact={true}
                                    render={({ match }) => (
                                        <ChangeArticle props={{match}} />
                                    )}
                                ></Route>
								<Route path="/article/:slug/edit" exact={true}
                                    render={({ match }) => (
                                        <ChangeArticle props={{match}} />
                                    )}
                                ></Route>
